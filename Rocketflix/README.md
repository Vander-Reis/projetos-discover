...
<h3 align="center">
	O rocketflix busca filmes aleatorios em uma API de filmes.
</h3>
...
## About
O rocketFlix consome uma API terceira para te ajudar a escolher aquele filme, no seu momento de indesição.
...
```bash
$git clone https://github.com/Vander-Reis/projetos-discover/tree/main/Rocketflix
```
